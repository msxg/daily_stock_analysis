...
- [DSA UI 重构方案](/Users/ddxx/Dev/TestWs/daily_stock_analysis/docs/dsa-ui-redesign-proposal.md)
...
| 当前阻塞 | 无 |
| 下一步 | 默认构建即接管旧 UI：`cd apps/dsa-ui && eval "$(fnm env)" && npm run build` |
...
| UI-601 | Phase 6 | 构建输出切换 | `done` | 默认输出 `static/`，支持 `build:preview` 回滚 |
...
- [ChatPage.tsx](/Users/ddxx/Dev/TestWs/daily_stock_analysis/apps/dsa-ui/src/features/chat/pages/ChatPage.tsx)
- [PortfolioPage.tsx](/Users/ddxx/Dev/TestWs/daily_stock_analysis/apps/dsa-ui/src/features/portfolio/pages/PortfolioPage.tsx)
- [BacktestPage.tsx](/Users/ddxx/Dev/TestWs/daily_stock_analysis/apps/dsa-ui/src/features/backtest/pages/BacktestPage.tsx)
- [SettingsPage.tsx](/Users/ddxx/Dev/TestWs/daily_stock_analysis/apps/dsa-ui/src/features/settings/pages/SettingsPage.tsx)
- [LoginPage.tsx](/Users/ddxx/Dev/TestWs/daily_stock_analysis/apps/dsa-ui/src/features/auth/pages/LoginPage.tsx)
- [agent.ts](/Users/ddxx/Dev/TestWs/daily_stock_analysis/apps/dsa-ui/src/shared/api/agent.ts)
- [workbench.spec.ts](/Users/ddxx/Dev/TestWs/daily_stock_analysis/apps/dsa-ui/e2e/workbench.spec.ts)
- [chat-session.integration.test.tsx](/Users/ddxx/Dev/TestWs/daily_stock_analysis/apps/dsa-ui/tests/integration/chat-session.integration.test.tsx)
- [login.integration.test.tsx](/Users/ddxx/Dev/TestWs/daily_stock_analysis/apps/dsa-ui/tests/integration/login.integration.test.tsx)
- [vite.config.ts](/Users/ddxx/Dev/TestWs/daily_stock_analysis/apps/dsa-ui/vite.config.ts)
...
| 2026-03-27 | 构建验证 | `eval "$(fnm env)" && npm run build` | ✅ | 输出 `static/` |
...
3. 执行 Node 环境初始化：`eval "$(fnm env)" && fnm use --install-if-missing --version-file-strategy=recursive`（读取仓库根目录 `.node-version`，切到 Node `22.13.0`）。
...
- 默认 `npm run build` 会直接输出 `static/` 并覆盖旧 UI 产物。
- 若需要并行预览开发，执行 `npm run build:preview`（输出 `static-ui-preview/`）。
